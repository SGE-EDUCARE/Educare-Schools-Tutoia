...
router.get('/bncc/general-search', TeacherController.searchGeneralCompetencies);
router.get('/bncc/specific-search', TeacherController.searchSpecificCompetencies);
